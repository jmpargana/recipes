<template>
  <div class="border rounded-2xl mt-8 px-4 py-3 shadow-md my-2">
    <div class="flex">
      <div class="w-5 h-5">
    ...
    <ul v-show="open && filteredSuggestions?.length > 0" class="pt-2">
      <li
...
export default {
  setup() {
    ...
    const addTag = (s) => {
      if (suggestions.value.includes(s) && !store.state.tags.includes(s)) {
